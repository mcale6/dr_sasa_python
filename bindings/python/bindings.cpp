...
extern void Generic_Solver(vector<atom_struct>& pdb, vector<float>& points, 
                         vector<vector<string>> obj1, int mode, int cl_mode);
...
PYBIND11_MODULE(dr_sasa_py, m) {
    ...
    py::class_<DrSASA>(m, "DrSASA")
        ...
        .def_property("probe_radius", 
                     &DrSASA::get_probe_radius,
                     &DrSASA::set_probe_radius)
